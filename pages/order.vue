...
const compute_price = (data: any) => {
  return data.reduce((total: number, element: any) => {
    return total + element.quantity * (element.unit_price - element.discount);
  }, 0);
};
...
const select_tab_handler = (tab: any) => {
  ...
  if (tab === "New Arrival") selected_tab.value = ["waiting", "pending"];
    ...
    selected_tab.value = ["accepted", "pickedup", "on the way"];
  else if (tab === "Completed") selected_tab.value = ["completed"];
  else if (tab === "Rejected") {
    selected_tab.value = ["rejected"];
  }
};
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="flex flex-row gap-3 items-center">
                ...
                <div class="flex flex-row gap-1 items-center">
                  ...
                  <span class="text-sm font-medium"
                    >{{
                      order_detail_value.shipping_address.sub_city.region_city
                        .translate.to[1].name
                    }},
