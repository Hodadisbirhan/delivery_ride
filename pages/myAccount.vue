...
const { updateUserPassword, updateUserProfile } = useFirebaseClient();
...
const handlePasswordChange = handleSubmit(async (value: any) => {
  console.log(value);
  const response = await updateUserPassword(value.newpassword);
        ...
        >
          ...
          >
            ...
            <div class="flex justify-end mt-1">
              <button
                type="submit"
                class="px-4 py-1 rounded-lg text-light300 bg-primaryvar1"
              >
                Save
              </button>
            </div>
